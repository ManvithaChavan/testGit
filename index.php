...
<body>
        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img src="images/m1-logo.jpg" alt=""></a> <span class="logo-text">Logo</span></h1></li>
                    </ul>
        ...
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <div class="row">
                <div class="col col s4 m4 l4">
                    <img src="images/download.png" alt="" class="circle responsive-img valign profile-image">
                </div>
  ...
  <footer class="page-footer">
    ...
    $("#formValidate").validate({
        ...
        messages: {
			<?php
			$result = mysqli_query($con, "CALL `getItems`();");
			while($row = mysqli_fetch_array($result))
			{  
				echo $row["id"].':{
				min: "Minimum 0",
